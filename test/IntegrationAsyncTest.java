...
public class IntegrationAsyncTest extends WithServer {
	...
	private void InitTest(String map, String origin, String destiny, String routeExpected, String costExpected, String distancyExpected) {
		...
		String body = RestAssured.given().contentType(ContentType.TEXT).content(map).expect().statusCode(200).when().post("/process/async/BH").body().asString();
